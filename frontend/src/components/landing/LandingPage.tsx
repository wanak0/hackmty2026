  ...
  return (
    <div className="min-h-screen bg-[#F2F4F8] text-[#1E242D] flex flex-col selection:bg-[#EB0029] selection:text-white">
      ...
      <header className="border-b border-gray-200 bg-white sticky top-0 z-40 shadow-xs">
        <div className="max-w-6xl w-full mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3.5">
            <BanorteLogo size="md" variant="red" />
          ...
          <button
            onClick={onStartDemo}
            className="px-5 py-2.5 rounded-xl bg-[#EB0029] hover:bg-[#D40024] text-white text-xs font-bold flex items-center gap-2 transition-all shadow-banorte-red active:scale-95"
          >
      ...
      <section className="max-w-5xl mx-auto px-6 pt-14 pb-20 text-center flex-1 flex flex-col items-center justify-center">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#FFF0F2] border border-[#FECDD3] text-[#EB0029] text-xs font-bold mb-6 shadow-xs">
          <span className="w-2 h-2 rounded-full bg-[#EB0029] animate-pulse" />
          <span>Hackathon Reto Banorte 2026 · Inteligencia Viva</span>
        </div>

        <h1 className="text-4xl sm:text-6xl font-black tracking-tight text-gray-900 max-w-3xl mb-6 leading-tight">
          Interfaces vivas que Banorte construye en <span className="text-[#EB0029]">tiempo real</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 mb-14">
          <button
            onClick={onStartDemo}
            className="w-full sm:w-auto px-9 py-4 rounded-2xl bg-[#EB0029] hover:bg-[#D40024] text-white font-black text-base shadow-banorte-red flex items-center justify-center gap-3 transition-all hover:scale-[1.02] active:scale-[0.98]"
          >
        ...
        <div className="w-full max-w-2xl bg-white border border-gray-200 rounded-3xl p-6 sm:p-7 shadow-sm relative overflow-hidden text-left mb-16">
          <div className="flex items-center justify-between pb-4 mb-5 border-b border-gray-100 text-xs text-gray-500">
            <div className="flex items-center gap-2">
              <span className="w-3 h-3 rounded-full bg-[#EB0029]" />
          ...
          <div className="bg-[#F8F9FB] rounded-2xl p-4 border border-gray-200 mb-4 flex items-center gap-3">
            <span className="text-xs uppercase font-black text-[#EB0029] bg-[#FFF0F2] px-2.5 py-1 rounded-lg border border-[#FECDD3]">
              CLIENTE
            </span>
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-5 shadow-xs">
            <div className="text-[11px] font-black uppercase tracking-wider text-[#EB0029] mb-1 flex items-center gap-1.5">
            ...
            <div className="space-y-2.5 text-xs">
              ...
              <div className="flex justify-between items-center p-3 bg-[#FFF5F6] rounded-xl border border-[#EB0029] shadow-xs">
                <span className="text-[#EB0029] font-black flex items-center gap-1.5">
                  <span className="w-2 h-2 rounded-full bg-[#EB0029]" />
                  18 meses · CAT 34.1% (Recomendado)
                </span>
                <span className="font-black text-[#EB0029] text-sm">$1,215 /mes</span>
              </div>
              <div className="flex justify-between items-center p-3 bg-[#F8F9FB] rounded-xl border border-gray-200">
