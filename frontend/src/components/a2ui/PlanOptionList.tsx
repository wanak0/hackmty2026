    ...
    <div className="space-y-3 mb-5">
      <div className="flex items-center justify-between px-1">
        <span className="text-xs font-bold text-gray-600 uppercase tracking-wider flex items-center gap-1.5">
          <Calendar className="w-3.5 h-3.5 text-[#EB0029]" /> Selecciona tu Plazo Banorte:
        </span>
        ...
        return (
          <div
            ...
            className={`cursor-pointer relative flex items-center justify-between p-4 sm:p-5 rounded-2xl border transition-all duration-200 ${
              isSelected
                ? 'bg-[#FFF5F6] border-[#EB0029] shadow-sm ring-1 ring-[#EB0029]/30'
            ...
            <div className="flex items-center gap-3.5">
              ...
              <div>
                <div className="text-base sm:text-lg font-bold text-gray-900 flex items-center gap-2">
                  ...
                  {isSelected && (
                    <span className="text-[10px] bg-[#FFF0F2] text-[#EB0029] px-2 py-0.5 rounded font-bold border border-[#FECDD3]">
                      SELECCIONADO
                    </span>
                  )}
                </div>
